...
{
	[Library]
	public class TrollgeController : BasePlayerController
	{
		public float SprintSpeed { get; set; } = 90.0f;
		public float WalkSpeed { get; set; } = 90.0f;
		public float DefaultSpeed { get; set; } = 90.0f;
		public float Acceleration { get; set; } = 10.0f;
		public float AirAcceleration { get; set; } = 30.0f;
		...
		public void OverwriteSprintSpeed(float TargetSpeed){

			SprintSpeed = TargetSpeed;

		}

		public TrollgeController()
		{
			//Duck = new Duck( this );
